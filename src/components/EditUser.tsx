...
const formSchema = z.object({
  ...
  phone: z
    .string()
    .min(10, { message: "Please Provide at least 10 digit Phone number" })
    .max(13),
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Only admin can see you Phone Number.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>This is public Address.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
